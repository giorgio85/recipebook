...
function insertRecipe()
{
   ...
   if (isset($_SESSION['id'])){
    $userId = $_SESSION['id'];}
    $sentence = "INSERT INTO recipe (name, description, id_level_difficulty, preparation_time, number_person, ingredients, instructions, calories, date, userid) VALUES
    ('$name','$description', '$difficulty', '$preparationTime', '$numberPerson', '$ingredients', '$instructions', '$calories', '$date', '$userId')";
