<?php
    ...
    if (isset($_SESSION['user'])){
		...
		$sentencia = "SELECT path FROM user_profile WHERE email = '$email'";
		...
		$form = '
				...
				<li>
					<a onclick="jshidden()" href="#"><img class="img-responsive" alt="" src="img/book-recipe.png"> My recipes </a>
				</li>
						...
						<div class='modal-dialog'>
							<div class='modal-content'>
								...
								<div class='modal-body'>
									<form id='form_new_recipe' action='CreateRecipe.php' method='post'>
										<div class='form-group'>
											<input type='text' class='form-control' id='name_recipe' name='recipeName' placeholder='Name of recipe'>
										</div>

										<div class='form-group'>
											<textarea id='description' name='recipeDescription' cols=77 rows=3 style=' resize: none;' placeholder=' &nbsp;Description'></textarea>
										</div>

										<div class='form-group'>

											<input type='file' id='inputFile' style='float:right; width: 260px; margin: 0 0px 0 0 '>
										...
										<div class='form-group'>
											<textarea id='instructions' name='recipeInstructions' cols=77 rows=4 style=' resize: none;' placeholder=' &nbsp;Instructions'></textarea>
										</div>
										<div class='form-group'>
											<textarea id='ingredients' name='recipeIngredients' cols=77 rows=3 style=' resize: none;' placeholder=' &nbsp;Enter ingredients separated by commas'></textarea>
										</div>
										<div class='form-group'>
											<textarea id='description' name='recipeLabels' cols=77 rows=3 style=' resize: none;' placeholder=' &nbsp;Enter tags separated by commas'></textarea>
										</div>
				...
				<li class='dropdown hidden-xs'>
					<a class='dropdown-toggle' data-toggle='dropdown' href='#'><img class='img-responsive' alt='' src='img/menu.png'/>Menu<b class='caret'></b></a>
