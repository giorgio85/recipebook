...
<div class="wrapper">
    <div class="header">
            ...
            <div class="header-top">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <a href="#" style="float:right; margin:25px -230px 0 0; width:70px;" style="outline:0;"><b>
        ...
        <div class="Error">
            ...
            <h1>SIGN-IN ERROR</h1>
            <p>This e-mail address is already in our databases. Please enter another e-mail or log-in if you are already signed up.</p>
        </div>
